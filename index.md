...
venue: "Room 38, Talbot Building"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room 38, Talbot Building, Swansea University, Singleton Park, Swansea SA2 8PP"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "March 8, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Mark Dawson"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
recon_channel: https://recon.swansea.ac.uk/#narrow/stream/29-Introduction-to-MPI-2019-03-08       # optional: url for specific recon channel to join
---
